...
<link rel="stylesheet" type="text/css" href="<c:url value='/font-awesome-4.2.0/css/font-awesome.css'/>"/>
...
<!-- Slider -->
<link href="<c:url value='/css/owl.carousel.css'/>" rel="stylesheet" media="screen"/>
<link href="<c:url value='/css/owl.theme.css'/>"  rel="stylesheet" media="screen"/>
...
<script src="<c:url value='/js/typed.js'/>" ></script>